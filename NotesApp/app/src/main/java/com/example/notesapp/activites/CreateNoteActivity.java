...
public class CreateNoteActivity extends AppCompatActivity {
    ...
    private void saveNote(){
        ...
        /*new BackgroundTask(CreateNoteActivity.this) {
            @Override
            ...
            class SaveNoteTask extends AsyncTask<Void,Void,Void> {
                ...
                protected void onPostExecute(Void aVoid) {
                    ...
                    Intent intent = new Intent();
                    setResult(RESULT_OK,intent);
                    Intent refresh = new Intent(CreateNoteActivity.this, MainActivity.class);
    ...
    private void showDeleteNoteDialog(){
        if(dialogDeleteNote == null){
            ...
            view.findViewById(R.id.textDateNote).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    @SuppressLint("StaticFieldLeak")
    ...
    ActivityResultLauncher<Intent> launchSomeActivity = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback<ActivityResult>() {
        ...
        public void onActivityResult(ActivityResult result) {
            if (result.getResultCode() == CreateNoteActivity.RESULT_OK){
            ...
            view.findViewById(R.id.textAdd).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if(inputURL.getText().toString().trim().isEmpty()){
                        Toast.makeText(CreateNoteActivity.this,"Url Girin",Toast.LENGTH_SHORT).show();
                    }else if(!Patterns.WEB_URL.matcher(inputURL.getText().toString()).matches()){
                        Toast.makeText(CreateNoteActivity.this,"Geçerli bi url girin",Toast.LENGTH_SHORT).show();
                    }else{
